...
class NotificationModel {
  ...
  NotificationModel(
      ...
      this.createdAt,
      this.initiatorId = '',
      this.state = NotificationState.EVENT_NEW_COMMENT,
      this.eventName = '',
      this.initiatorName = '',
      this.seenByMe = false});
  ...
  factory NotificationModel.fromDB(Map<String, dynamic> table) {
    return NotificationModel(
        ...
        state: NotificationState.values.firstWhere(
            (e) => e.toString() == 'NotificationState.' + table['state']));
  }
...
Map<String, dynamic> _NotificationModelToMap(NotificationModel instance) =>
    <String, dynamic>{
      'notificationId': instance.notificationId,
      'eventId': instance.eventId,
      'eventName': instance.eventName,
